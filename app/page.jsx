const Home = () => {
  return (
    <section className="w-full h-auto flex-center flex-col mt-10 lightglass">
      <h1 className="head_text text-center">
        Discover & Share
        <br className="max-md:hidden" />
      </h1>
      <span className="desc_text violet_gradient text-center my-8 py-8 drop-shadow-md text-white">
      ...
      <br className="max-md:hidden" />
      <h2 className="text-center text-xl sm:mx-20 sm:px-20 text-white">
